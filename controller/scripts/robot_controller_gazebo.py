...
command_topics = ["/spot_gazebo/FL_cntr/command",
                  ...
                  "/spot_gazebo/ML1_cntr/command",
                  "/spot_gazebo/ML1_servo_cntr/command",
                  "/spot_gazebo/ML1_link1_cntr/command",
                  "/spot_gazebo/ML1_link2_cntr/command",
                  "/spot_gazebo/MR1_cntr/command",
                  "/spot_gazebo/MR1_servo_cntr/command",
                  "/spot_gazebo/MR1_link1_cntr/command",
                  "/spot_gazebo/MR1_link2_cntr/command",
                  "/spot_gazebo/ML2_cntr/command",
                  "/spot_gazebo/ML2_servo_cntr/command",
                  "/spot_gazebo/ML2_link1_cntr/command",
                  "/spot_gazebo/ML2_link2_cntr/command",
                  "/spot_gazebo/MR2_cntr/command",
                  "/spot_gazebo/MR2_servo_cntr/command",
                  "/spot_gazebo/MR2_link1_cntr/command",
                  "/spot_gazebo/MR2_link2_cntr/command",
